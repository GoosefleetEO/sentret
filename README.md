# sentret
 An Awful Authbot for Stoat, from Goosefleet with love.
...
Fill in secrets.ini based on the example file in the repo. The SA info can be pulled from observing a request in the Developer Console or by exporting your cookies. The bot token you will get when creating the bot in Stoat web. 
